...
import { SecureFileService } from './securefile/secure-file.service';

import { ForbiddenComponent } from './forbidden/forbidden.component';
import { HomeComponent } from './home/home.component';
import { UnauthorizedComponent } from './unauthorized/unauthorized.component';
import { SecurefileComponent } from './securefile/securefile.component';
...
const l10nConfig: L10nConfig = {
    ...
    translation: {
        providers: [
            { type: ProviderType.Static, prefix: 'http://localhost:15107/i18n/locale-' }
        ],
        caching: true,
        missingValue: 'No key'
    }
...
export class AppModule {
    ...
    configClient() {
        ...
        console.log('http://localhost:37950/api/ClientAppSettings');

        //return this.http.get(`${window.location.origin}/api/ClientAppSettings`);
        return this.http.get('http://localhost:37950/api/ClientAppSettings');
    }
}
